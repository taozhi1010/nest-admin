...
const cycleTotal = computed(() => {
  ...
  const checked02 = props.check(cycle02.value, cycle01.value + 1, 23)
  return `${checked01}-${checked02}`
})
const averageTotal = computed(() => {
  const checked01 = props.check(average01.value, 0, 22)
  const checked02 = props.check(average02.value, 1, 23 - average01.value)
  return `${checked01}/${checked02}`
})
