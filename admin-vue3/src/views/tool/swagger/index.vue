<template>
   <div class="swagger-container">
      <el-tabs v-model="activeTab" type="border-card" class="swagger-tabs">
         <el-tab-pane label="Swagger UI" name="swagger">
            <i-frame v-model:src="swaggerUrl"></i-frame>
         </el-tab-pane>
         <el-tab-pane label="Redoc 文档" name="redoc">
            <i-frame v-model:src="redocUrl"></i-frame>
         </el-tab-pane>
         <el-tab-pane label="Apifox 导入" name="apifox">
            <div class="apifox-container">
               <el-alert title="Apifox 导入说明" type="info" :closable="false" show-icon class="apifox-alert">
                  <template #title>
                     <div class="apifox-content">
                        <span class="apifox-text">点击下方链接导入 Apifox：</span>
                        <a :href="apifoxJsonUrl" target="_blank" class="apifox-link">
                           {{ apifoxJsonUrl }}
                           <el-icon>
                              <Link />
                           </el-icon>
